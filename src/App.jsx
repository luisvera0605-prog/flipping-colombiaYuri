  ...
  return (
    <div style={{marginTop:12}}>
      <button onClick={()=>setOpen(o=>!o)} style={{
        ...
        <span>📋 Referencia de precios — Itagüí / Valle de Aburrá 2025</span>
      ...
      {open&&(
        <div style={{marginTop:8,display:"flex",flexDirection:"column",gap:6}}>
          <div style={{padding:"8px 12px",background:COL.amberL,borderRadius:8,fontSize:11,color:COL.amber,lineHeight:1.5}}>
            Precios incluyen mano de obra + materiales. Base: Itagüí y Valle de Aburrá 2025. Base: Itagüí y Valle de Aburrá · Bogotá +12% · Costa -5% · Ciudades intermedias -7%
          </div>
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:4}}>
      ...
      <div style={{padding:"6px 10px",background:COL.blueL,borderRadius:8,fontSize:11,color:COL.blue,marginBottom:4}}>
        Base: Itagüí y Valle de Aburrá · Bogotá +12% · Costa -5% · Ciudades intermedias -7%
      </div>
